    ...
    <div class="container">
      ...
      <div class="row justify-content-md-center">
        <a class="col-2 btn btn-dark btn-block btn-comprar my-2"
          href="<?php echo SITE_URL ?>/Views/produtos/create-genero.php"
          role="button">Cadastrar Gênero</a>
      </div>
      <div class="row justify-content-md-center">
        <div class="col-10">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="col-3"><a class=" btn btn-dark btn-comprar"
                    href="<?php echo SITE_URL ?>/Views/produtos/alter-genero.php?genero=<?php echo $linha['cod_genero']; ?>"
                    role="button">Alterar</a>
                  <a class=" btn btn-dark btn-comprar"
                    href="<?php echo SITE_URL ?>/Controllers/c_produto.php?excluir=<?php echo $linha['cod_genero']; ?>"
                    name="excluir-genero" id="excluir-genero">Excluir</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
